    ...
    <div class="h-full bg-white flex min-h-full flex-1">
        <div class="flex flex-1 flex-col justify-center px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
            <div class="mx-auto w-full max-w-sm lg:w-96">
                <div>
                    <h2 class="mt-8 text-2xl font-bold leading-9 tracking-tight text-gray-900">Sign up for an account
                    </h2>
                    <p class="mt-2 text-sm leading-6 text-gray-500">
                        Already have an account!
                        {{ ' ' }}
                        <RouterLink to="/sign-in" class="font-semibold text-indigo-600 hover:text-indigo-500">Sign in
                            here</RouterLink>
                    </p>
                </div>
                        ...
                        <form @submit.prevent="submitForm" class="space-y-6">
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    ...
                                    <label for="remember-me" class="ml-3 block text-sm leading-6 text-gray-700">Agree to
                                        our
                                    </label>
                                </div>

                                <div class="text-sm leading-6">
                                    <a href="#" class="font-semibold text-indigo-600 hover:text-indigo-500">Terms &
                                        conditions</a>
                                </div>
                            </div>
