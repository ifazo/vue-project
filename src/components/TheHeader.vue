  ...
  <header class="bg-white">
    ...
    >
      ...
      <PopoverGroup class="hidden lg:flex lg:gap-x-12">
        ...
        <RouterLink to="/products" class="text-sm font-semibold leading-6 text-gray-900"
          >Products</RouterLink
        >
        <RouterLink to="/blogs" class="text-sm font-semibold leading-6 text-gray-900"
          >Blogs</RouterLink
        >
        <RouterLink to="/dashboard" class="text-sm font-semibold leading-6 text-gray-900"
