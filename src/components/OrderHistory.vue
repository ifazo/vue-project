                            ...
                            <tbody class="border-b border-gray-200 divide-y divide-gray-200 text-sm sm:border-t">
                                <tr v-for="product in order.products" :key="product.id">
                                    ...
                                    <td class="py-6 font-medium text-right whitespace-nowrap">
                                        <a :href="product.href" class="text-indigo-600">View<span
...
const orders = [
    {
        ...
        products: [
            ...
            {
                id: 2,
                name: 'Leather Zip Portfolio',
                href: '#',
                price: '$168.00',
                status: 'Delivered Jan 25, 2021',
                imageSrc: 'https://tailwindui.com/img/ecommerce-images/order-history-page-02-product-02.jpg',
                imageAlt: 'Top view of leather zip portfolio with black leather material, multi-pocket organizer, and pen sleeve.',
            }, 
            {
                id: 3,
                ...
                price: '$35.00',
                status: 'Delivered Jan 25, 2021',
                imageSrc: 'https://tailwindui.com/img/ecommerce-images/order-history-page-02-product-03.jpg',
                imageAlt: 'Black machined steel mechanical pencil with chrome lead tip next to small notepad and two stacked books.',
            }
        ],
    },
    {
        ...
        products: [
            {
                ...
                href: '#',
                price: '$38.00',
                status: 'Delivered Jan 30, 2021',
                imageSrc: 'https://tailwindui.com/img/ecommerce-images/order-history-page-02-product-04.jpg',
                imageAlt: 'Side view of stainless steel Nomad Tumbler with black cap and base on white background.',
            },
            {
                id: 2,
                name: 'Machined Pen and Pencil Set',
